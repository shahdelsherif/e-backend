...
export default function SearchAndUpdateInstructorCourse() {
  const [searchId, setSearchId] = useState(''); // ID to search for the course by instructor
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <h1 className="text-3xl font-bold text-gray-800 mb-6">Search and Update Course by Instructor</h1>
