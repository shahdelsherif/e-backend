...
export default function SearchAndUpdateInstructor() {
  const [searchId, setSearchId] = useState(''); // ID to search for user (instructor/student)
  ...
  const fetchUserDetails = async () => {
    try {
      ...
      if (!searchId) {
        setError('Please provide a user name to search.');
        return;
      }
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <h1 className="text-3xl font-bold text-gray-800 mb-6">Search and Update User</h1>

      <div className="bg-white p-6 rounded-lg shadow-md">
        <h2 className="text-xl font-semibold text-gray-800 mb-4">Search for a Instructor by ID</h2>
        ...
        {isUserFound && (
          <div className="mt-8 bg-white p-6 rounded-lg shadow-md">
            <h2 className="text-xl font-semibold text-gray-800 mb-4">Update Instructor Details</h2>
