...
export class BackupService {
  ...
  private readonly dbName = 'schema'; // Database name to backup
  private readonly backupDir = '/Users/shahd/Downloads/SWP1/e-backend/src/backup'; // Backup directory path
