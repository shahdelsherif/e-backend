...
export class ForumsController {
  ...
  @Get('forum/:id')
  async getForumByCourseId(@Param('id') id: string) {
    return await this.forumsService.getForumById(id);
  }

  @Get(':courseId')
  async getForumsByCourseId(@Param('courseId') courseId: string){
      return this.forumsService.getForumsByCourseId(courseId);
  }
