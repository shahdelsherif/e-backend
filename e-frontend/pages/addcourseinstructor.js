...
export default function AddCourseInstructor() {
  ...
  const handleAddCourse = async () => {
    try {
      ...
      // Redirect to instructor dashboard after successful course creation
      setTimeout(() => {
        router.push('/instructorDashboard');
      }, 500); // Delay to ensure success message shows before redirect
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <h1 className="text-3xl font-bold text-gray-800 mb-6">Add New Course with Instructor</h1>

      <div className="bg-white p-6 rounded-lg shadow-md">
        <h2 className="text-xl font-semibold text-gray-800 mb-4">Enter Course and Instructor Details</h2>
